...
function handleImageJoining (sock, peerTable, searchHistory, maxPeers, sender) {
    ...
    sock.on('data', function (requestPacket) {
        handleClientRequests(requestPacket, sock, peerTable, searchHistory, maxPeers, sender); //read client requests and respond
...
function handleClientRequests(data, sock, peerTable, searchHistory, maxPeers, sender) {
